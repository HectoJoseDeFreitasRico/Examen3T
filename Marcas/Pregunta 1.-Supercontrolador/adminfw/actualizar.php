  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" novalidate method="POST" action="procesaactualizar.php">
          ...
          <input type="hidden" class="form-control" name="tabla" id="address2" value="<?php echo $_GET['tabla'] ?>">
          <input type="hidden" class="form-control" name="id" id="address2" value="<?php echo $_GET['id'] ?>">
        <?php
          ...
          while($fila = $resultado->fetch_assoc()){
              echo'
                <div class="mb-3">
                  <label for="address2" style="text-transform:capitalize;">'.$fila['Field'].' <span class="text-muted">(Optional)
                  </span></label>';
//////////////////////////////////////////////////////////////////
